...
import com.basePackage.PhysicalLayer.Exceptions.RepeatedAttributeException1;
...
public class TupleDesc implements Serializable {
    ...
    public TupleDesc(Type[] typeAr, String[] fieldAr, Boolean[] nullableAr, boolean mustPresentValidKey) throws RepeatedAttributeException1, InvalidKeyException {
        ...
        for (int i = 0; i < typeAr.length; i++) {
            ...
            for(int j = 0; j < typeAr.length; j++){
                ...
                if(fieldAr[i] == fieldAr[j] && i != j)throw new RepeatedAttributeException1(fieldAr[i]);
            }
    ...
    public TupleDesc(Type[] typeAr, String[] fieldAr, Boolean[] nullableAr) throws RepeatedAttributeException1, InvalidKeyException {
     ...
     */
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2, boolean mergeKeys) throws RepeatedAttributeException1, InvalidKeyException {
        ...
        if(intersection.size() > 0){
            throw new RepeatedAttributeException1(intersection.toString());
        }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) throws RepeatedAttributeException1, InvalidKeyException {
        return merge(td1, td2, true);
    }

    public TupleDesc subset(List<String> nameFields, String nameTable) throws RepeatedAttributeException1, InvalidKeyException, NotFoundedAttributeException {
