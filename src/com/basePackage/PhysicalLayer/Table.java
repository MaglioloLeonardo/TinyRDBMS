...
public class Table implements Serializable {
    ...
    public void addForeignKey(TupleDesc fk) throws RepeatedAttributeException, InvalidKeyException, RepeatedAttributeException1 {
        if(fk != null) {
    ...
    public void performJoin(Table leftTable, Table rightTable, WhereBooleanTree tree) throws RepeatedAttributeException, NotFoundedAttributeException, InvalidTypesException, InvalidKeyTupleException, InvalidTupleException, InvalidFieldException, com.basePackage.PhysicalLayer.Exceptions.InvalidTupleException {
    ...
    public void performCartesianProduct(Table leftTable, Table rightTable) throws RepeatedAttributeException, NotFoundedAttributeException, InvalidTypesException, InvalidKeyTupleException, InvalidTupleException, InvalidFieldException, com.basePackage.PhysicalLayer.Exceptions.InvalidTupleException {
