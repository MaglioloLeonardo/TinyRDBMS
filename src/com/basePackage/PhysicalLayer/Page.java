...
class Page implements Serializable {
    ...
    static void performJoin(Table table, Table leftTable, Page leftPage, Table rightTable, Page rightPage, WhereBooleanTree tree) throws NotFoundedAttributeException, InvalidTypesException, InvalidKeyTupleException, InvalidTupleException, InvalidFieldException, com.basePackage.PhysicalLayer.InvalidTupleException {
