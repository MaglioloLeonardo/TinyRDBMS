...
public class OperationTableNode implements FromClauseNode{
    ...
    @Override
    public Table execute() throws RepeatedAttributeException, InvalidKeyException, InvalidKeyTupleException, NotFoundedAttributeException, InvalidTypesException, InvalidTupleException, InvalidFieldException {
